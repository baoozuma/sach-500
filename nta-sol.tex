...
\begin{itemize}[label=, leftmargin=0em, itemsep=0.5em]
    ...
    \begin{sol}
        ...
        \begin{center}
            \includegraphics[scale=0.6]{Image/P1.1.pdf}
            \hspace{1cm}
            \includegraphics[scale=0.6]{Image/P1.2.pdf}
        \end{center}
        ...
        \begin{center}
            ...
            \hspace{1cm}
            \includegraphics[scale=0.3]{Image/P1.4.pdf}
        \end{center}
    \end{sol}
    ...
    \item \begin{btvn}\vocab{(IMO Shortlist 2013).}
